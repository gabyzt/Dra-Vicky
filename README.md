...
<DIV STYLE="position:absolute; top:0px; left:0px; visibility:visible z-index:1">
		<input type="image" id="loader" value="ALARMA" name="boton" src="https://raw.githubusercontent.com/gabyzt/Dra-Vicky/master/index%20file/load2.gif" onclick="alarma();" width="107%" height="1000px">
